...
dataset = load_cached(cache_path='my_dataset_cache.pkl', in_dir= 'data/my_images')#'/home/minhnguyen/Desktop/Documents/taiwan_project/tutorial/TensorFlow-Tutorials/data/my_images')
...
file_path_cache_train = os.path.join(data_dir, 'my_images_train.pkl')
file_path_cache_test = os.path.join(data_dir, 'my_images_test.pkl')
...
def predict_cls(transfer_values, labels, cls_true):
    ...
    i = 0
    #labels = np.reshape(labels, (530,4))
